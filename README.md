...
[GitHub Release](https://github.com/nsimi22/tablesplusplus/releases) — current version: **v0.3.0**.

| Platform | Download |
|----------|----------|
| macOS (universal — Apple Silicon + Intel) | [`.dmg`](https://github.com/nsimi22/tablesplusplus/releases/download/v0.3.0/Tables%2B%2B_0.3.0_universal.dmg) |
| Windows | [`.msi`](https://github.com/nsimi22/tablesplusplus/releases/download/v0.3.0/Tables%2B%2B_0.3.0_x64_en-US.msi) / [`.exe`](https://github.com/nsimi22/tablesplusplus/releases/download/v0.3.0/Tables%2B%2B_0.3.0_x64-setup.exe) |
| Linux | [`.AppImage`](https://github.com/nsimi22/tablesplusplus/releases/download/v0.3.0/Tables%2B%2B_0.3.0_amd64.AppImage) / [`.deb`](https://github.com/nsimi22/tablesplusplus/releases/download/v0.3.0/Tables%2B%2B_0.3.0_amd64.deb) / [`.rpm`](https://github.com/nsimi22/tablesplusplus/releases/download/v0.3.0/Tables%2B%2B-0.3.0-1.x86_64.rpm) |
